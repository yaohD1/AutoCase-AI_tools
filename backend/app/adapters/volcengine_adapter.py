...
class VolcengineAdapter(BaseAIAdapter):
    def __init__(self, api_key: str, api_base: str = "https://api.yygu.cn/v3/llm.chat/chat/completions", model: str = "doubao-seed-2.0-lite", temperature: float = 0.7, max_tokens: int = 2000, timeout: int = 170):
...
5. 返回有效的JSON数组"""
            ...
            raise Exception(f"Volcengine API request error: {str(e)}")
